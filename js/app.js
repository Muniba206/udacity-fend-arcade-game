/**
 * @file overview Classic Arcade Game built as Project for Udacitys' Frontend Nanodegree.
 * @author Muniba Talha 
 **/
...
$(document).ready(function() {
		...
		$("#playGame").click(function() { 
				// On starting game initial dialouge box disappears
				$("#startScreen").fadeOut('fast'); 

				/* Move the keys to start/unpause the game */	
				paused = false;
		});
